...
class FriendsThread(models.Model):
    friends_User_id_Person1 = models.ForeignKey(ConverseNetUser, on_delete=models.CASCADE, null=True, related_name='person1')
    friends_User_id_Person2 = models.ForeignKey(ConverseNetUser, on_delete=models.CASCADE, null=True)
class Requests(models.Model):
    friends_User_id_Person1 = models.ForeignKey(ConverseNetUser, on_delete=models.CASCADE, null=True, related_name='person12')
    friends_User_id_Person2 = models.ForeignKey(ConverseNetUser, on_delete=models.CASCADE, null=True)
